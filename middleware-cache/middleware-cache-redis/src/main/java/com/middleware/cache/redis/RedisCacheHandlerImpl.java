...
import com.middleware.cache.core.CacheData;
import com.middleware.cache.core.CacheHandler;
import com.middleware.cache.core.RankingData;

import static com.middleware.cache.redis.SerializeUtils.deserializeKey;
import static com.middleware.cache.redis.SerializeUtils.deserializeObject;
import static com.middleware.cache.redis.SerializeUtils.deserializeValue;
import static com.middleware.cache.redis.SerializeUtils.serializeKey;
import static com.middleware.cache.redis.SerializeUtils.serializeObject;
import static com.middleware.cache.redis.SerializeUtils.serializeValue;
...
public class RedisCacheHandlerImpl implements CacheHandler {
    ...
    @Override
    public <T> T cache(String key, Class<?> clazz, CacheData<T> data, Integer expireTime) {
        byte[] bKey = serializeKey(key);
        byte[] bValue = executer.query(con -> con.get(bKey));
    ...
    public String getString(String key) {
        byte[] bKey = serializeKey(key);
        return deserializeKey(executer.query(con -> con.get(bKey)));
    }
